...
function writeToScreen(message) {
	...
	function animloop() {
	var animLoopHandle = window.requestAnimFrame(animloop);
	mainLoop();
	}
...
//writeToScreen("Poczatek");
function playAsGuest (playerName, serverAdr, idRoom) {
	writeToScreen("playAsGuest");
	writeToScreen(playerName);
	c = new Client(playerName, serverAdr, idRoom);
	writeToScreen(window);
	c.connect();
	//writeToScreen("Po connect");
	animloop();
}